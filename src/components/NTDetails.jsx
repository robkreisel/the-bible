    ...
    <div>
        ...
        <div className="flex flex-wrap gap-1">
          {data
            .filter(function (book) {
              return book.category.includes("history");
            })
            .map((book) => (
      ...
      <div className="m-3 p-3 md:m-10 bg-gray-100 shadow-md overflow-hidden">
        ...
        <div className="flex flex-wrap gap-1">
          {data
            .filter(function (book) {
              return book.category.includes("paulsLetter");
            })
            .map((book) => (
              <Book book={book} key={book.symbol} />
            ))}
      ...
      <div className="m-3 p-3 md:m-10 bg-gray-100 shadow-md overflow-hidden">
        ...
        <div className="flex flex-wrap gap-1">
          {data
            .filter(function (book) {
              return book.category.includes("generalLetter");
            })
            .map((book) => (
              <Book book={book} key={book.symbol} />
            ))}
      ...
      <div className="m-3 p-3 md:m-10 bg-gray-100 shadow-md overflow-hidden">
        ...
        <div className="flex flex-wrap gap-1">
          {data
            .filter(function (book) {
              return book.category.includes("prophecy");
            })
            .map((book) => (
              <Book book={book} key={book.symbol} />
            ))}
